...
<div id="articles-head" class="row">
  ...
  <div class="col-md-5">
    ...
    <div class="card hvr-float">
      ...
      <div class="card-img-overlay">
        <div class="card-content">
          <h4><a class="card-title" href="/<?= $slug ?>/<?= str_replace('-', '/', substr($contents[2]['date'], 0, -12)) ?>/<?= $contents[2]['slug'] ?>">
            <?= $contents[2]['title'] ?>
          </a></h4>
          <h6 class="card-details">
            By PPEIV2 &#8226; 
            ...
            <span id="h-time-2"></span> &#8226;
              <?= $this->registerJs('var ht2 = $("#h-time-2"); ht2.text("Published "+moment("'.$contents[2]['date'].'").fromNow());'); ?>
            <i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
            <i class="fa fa-twitter" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Tweet"></i>
          </h6>
        </div>
...
<div id="articles-subhead" class="row">
  <div class="col-md-4">
    <div class="card hvr-float">
      ...
      <div class="card-img-overlay">
        <div class="card-content">
          <h4><a class="card-title" href="/<?= $slug ?>/<?= str_replace('-', '/', substr($contents[3]['date'], 0, -12)) ?>/<?= $contents[3]['slug'] ?>">
            <?= $contents[3]['title'] ?>
          </a></h4>
          <h6 class="card-details">
            By PPEIV2 &#8226; 
            <i class="fa fa-clock-o" aria-hidden="true"></i>
              <span id="sh-time-1"></span> &#8226;									
              <?= $this->registerJs('var sh1 = $("#sh-time-1"); sh1.text("Published "+moment("'.$contents[3]['date'].'").fromNow());'); ?>
            <i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
            <i class="fa fa-twitter" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Tweet"></i>
          </h6>
        </div>
  ...
  <div class="col-md-4">
    <div class="card hvr-float">
      ...
      <div class="card-img-overlay">
        <div class="card-content">
          <h4><a class="card-title" href="/<?= $slug ?>/<?= str_replace('-', '/', substr($contents[4]['date'], 0, -12)) ?>/<?= $contents[4]['slug'] ?>">
            <?= $contents[4]['title'] ?>
          </a></h4>
          <h6 class="card-details">
            By PPEIV2 &#8226; 
            <i class="fa fa-clock-o" aria-hidden="true"></i>
              <span id="sh-time-4"></span> &#8226;									
              <?= $this->registerJs('var sh4 = $("#sh-time-4"); sh4.text("Published "+moment("'.$contents[4]['date'].'").fromNow());'); ?>
            <i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
            <i class="fa fa-twitter" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Tweet"></i>
          </h6>
        </div>
  ...
  <div class="col-md-4">
    <div class="card hvr-float">
      ...
      <div class="card-img-overlay">
        <div class="card-content">
          <h4><a class="card-title" href="/<?= $slug ?>/<?= str_replace('-', '/', substr($contents[5]['date'], 0, -12)) ?>/<?= $contents[5]['slug'] ?>">
            <?= $contents[5]['title'] ?>
          </a></h4>
          <h6 class="card-details">
            By PPEIV2 &#8226; 
            <i class="fa fa-clock-o" aria-hidden="true"></i>
              <span id="sh-time-5"></span> &#8226;									
              <?= $this->registerJs('var sh5 = $("#sh-time-5"); sh5.text("Published "+moment("'.$contents[5]['date'].'").fromNow());'); ?>
            <i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
            <i class="fa fa-twitter" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Tweet"></i>
          </h6>
        </div>
