		...
		<div id="news-subhead" class="row">
			<div class="col-md-4">
				<div class="card hvr-float">
					...
					<div class="card-img-overlay">
						...
						<h5 class="card-title">Adipisci voluptatem porro possimus facilis.</h5>
							<h6>
								By PPEIV2 &#8226; 
			...
			<div class="col-md-4">
				<div class="card hvr-float">
					...
					<div class="card-img-overlay">
						<div class="card-content">
							<h5 class="card-title">Ea nisi corrupti repellat deserunt!</h5>
							<h6>
								By PPEIV2 &#8226; 
								<i class="fa fa-clock-o" aria-hidden="true"></i> X days ago &#8226;
								<i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
			...
			<div class="col-md-4">
				<div class="card hvr-float">
					...
					<div class="card-img-overlay">
						<div class="card-content">
							<h5 class="card-title">Dolorum qui voluptates nisi dolor.</h5>
							<h6>
								By PPEIV2 &#8226; 
								<i class="fa fa-clock-o" aria-hidden="true"></i> X days ago &#8226;
								<i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Share"></i>
